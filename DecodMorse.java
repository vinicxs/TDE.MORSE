public class DecodMorse {
    ...
    private char morseParaCaractere(NoArvore raiz, String sequencia, int indice) {
        ...
        if (indice == sequencia.length()) {
            ...
            if (simbolo == '.') {
                return morseParaCaractere(raiz.getladoEsquerdo(), sequencia, indice + 1);
            } else if (simbolo == '-') {
                return morseParaCaractere(raiz.getLadoDireito(), sequencia, indice + 1);
            } else {
                return '\0';
            }
        }
    ...
    public String DecodMorse(String morse) {
